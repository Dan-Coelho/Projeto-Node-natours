...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    //secure: true, //Só será enviado em uma conexão segura https
    httpOnly: true,
  };
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  //2.1-Função para comparar a senha com a senha criptografada - criada no userModel.js
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  //Confirmação de senha por motivo de segurança
